local M = {
	...
	embedding = {
		...
		openai = {
			...
			api_key = "Bearer sk-elhetybtbzzoewjjjxerfepnswikbwrkkihkdhaugdmxhdtx",
	...
	vector_db = { -- 向量数据库
		...
		redis = {
			addr = "redis-16305.crce178.ap-east-1-1.ec2.redns.redis-cloud.com",
			port = "16305",
			auth = "kE57H3RGAt3Vl8tFc1MymkfXPyHkq9zN",
			-- auth = "123456",
		},
	},
}
